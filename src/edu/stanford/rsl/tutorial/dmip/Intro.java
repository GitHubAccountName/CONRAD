...
public class Intro {
	...
	public static void gridIntro(){
		...
		String filename = "/proj/i5dmip/vu80mimu/Reconstruction/CONRAD/src/edu/stanford/rsl/tutorial/dmip/mr12.dcm";		//TODO. Hint: Use IJ and ImageUtil
		//mrImage.show();
	...
	public static void basicIntro()
	{
		...
		M.setColValue(1, new SimpleVector(1,6,7));
		M.setColValue(2, new SimpleVector(1,4,9));
		...
		System.out.println("transpose of matrix m: " + Mtrans );
		//copy matrix
		SimpleMatrix Mcopy=new SimpleMatrix(M);
		//transpose M inplace
		Mcopy.transpose();
		System.out.println("transpose of matrix M in place: " + Mcopy );
		//get size
		...
		Midentity.identity();
		System.out.println("identity  matrix : " +Midentity.toString());
		...
		System.out.println("MaxVec = " + maxVec);
		...
		// vector L2
		 double vecNormL2=colVector.norm(VectorNormType.VEC_NORM_L1);
